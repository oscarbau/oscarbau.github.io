...
<p>This application takes landsat 8 images of a period, makes a best pixel mosaic, then computes NDVI and NWDI indices for the images. An interactive slice bar is added thus the user can fine tune the mapping water body mapping based on the indices and the elevation of the area of interest.&nbsp;</p>
